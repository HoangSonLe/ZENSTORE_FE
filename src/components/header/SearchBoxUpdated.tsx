            ...
            <div className="position-relative w-100" ref={searchBoxRef}>
                ...
                >
                    <div className="search-form__wrapper position-relative w-100">
                        <input
                            type="text"
                            className="search-form__input desktop-search-input common-input py-13 ps-16 pe-18 w-100"
                    ...
                    <button
                        type="submit"
                        className="desktop-search-button flex-center text-xl text-white flex-shrink-0 w-48 d-lg-flex d-none"
